        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="relative">
            <img
              ...
              :alt="`Histoire du ${clubConfig?.name}`"
...
useSeoMeta({
  ...
  description: `Découvrez l'histoire, la mission et l'équipe du ${clubConfig?.name || "Club Pongiste Libercourtois"}. Plus de 50 ans de passion pour le tennis de table à Libercourt.`,
  keywords:
...
function openGoogleMaps() {
  ...
  const url =
    ...
    `https://www.google.com/maps/place/@${locationData.lat},${locationData.lng},17z`;
