        ...
        <div class="space-y-8">
          ...
          >
              ...
              >
                ...
                <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                  <div class="flex items-center justify-between">
                    ...
                    <UButton
                      :variant="
                        expandedTeams.includes(team.uniqueKey) ? 'solid' : 'outline'
                      "
                      size="sm"
                ...
                <div
                  v-if="expandedTeams.includes(team.uniqueKey)"
                  class="p-6"
                >
                  ...
                  <!-- Liste des matchs -->
                  <div
                    v-else-if="teamMatches[team.uniqueKey]?.length > 0"
                    class="space-y-3"
                  >
            ...
            >
              ...
              />
              <p class="text-sm">
                Aucune équipe {{ selectedCategory === 'juniors' ? 'junior' : selectedCategory === 'seniors' ? 'adulte' : '' }} dans cette phase
              </p>
            </div>
          </div>
        </div>
...
const currentPhase = computed(() => {
  return sortedPhases.value.length > 0 ? sortedPhases.value[0] : 1
})

// Teams grouped by phase
const teamsByPhase = computed(() => {
  if (!teams.value?.success || !teams.value.data) return {}
