    ...
    <section id="schedules" class="py-16 page-section">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 mb-12">
          <div
            v-for="daySchedule in data.schedulesGrouped?.training"
            :key="daySchedule.day"
        ...
        <div class="adaptive-bg-secondary rounded-xl p-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div
              v-for="competition in data.schedulesGrouped?.competitions"
              :key="competition.day"
    ...
    <section id="pricing" class="py-16 adaptive-bg-secondary">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div
            v-for="pricing in data.pricingGrouped?.annual"
        ...
        <div class="adaptive-card rounded-xl shadow-lg p-8 mb-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div
              v-for="service in data.pricingGrouped?.additional"
        ...
        <div class="reductions-section rounded-xl shadow-lg p-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div
              v-for="reduction in data.pricingGrouped?.reductions"
              :key="`${reduction.category}-${reduction.details}`"
              ...
              >
                <span class="text-club-navy font-bold text-xl">{{
                  reduction.reductionAmount
                    ? formatPrice(reduction.reductionAmount)
                    : "—"
                }}</span>
              </div>
...
useSeoMeta({
  ...
  description: `Découvrez les horaires d'entraînement et les tarifs du ${clubConfig.value?.name || "Club Pongiste Libercourtois"}. Des créneaux adaptés à tous les âges et tous les niveaux.`,
  keywords:
