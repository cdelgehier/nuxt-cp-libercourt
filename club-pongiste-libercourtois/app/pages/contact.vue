          ...
          <div class="lg:col-span-2">
            <div class="adaptive-card rounded-xl overflow-hidden h-96">
              <iframe
                ...
                class="rounded-xl"
                :title="`Localisation du ${clubConfig?.name || 'Club Pongiste Libercourtois'}`"
              />
            </div>
...
useSeoMeta({
  title: "Contact",
  description: `Contactez le ${clubConfig.value?.name || "Club Pongiste Libercourtois"}. Trouvez toutes nos coordonnées, horaires de permanence et plan d'accès à notre salle de sport.`,
  keywords:
